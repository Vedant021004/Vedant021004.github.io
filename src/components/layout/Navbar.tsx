    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 text-black dark:text-white transition-colors">
          ...
          <a href="mailto:vedant@example.com" className="px-6 py-2 bg-[#2c2c2c] dark:bg-white text-white dark:text-black rounded-full text-sm font-semibold hover:bg-black dark:hover:bg-gray-200 transition-colors ml-2">
            Let's talk
          </a>
        </div>
      </div>
